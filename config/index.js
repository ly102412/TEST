...
module.exports = {
  ...
  dev: {
    ...
    proxyTable: {
      '/api': {
        target: 'http://mas.tst.ruwe.cn ',/*http://192.168.199.116:7012*/ // 目标地址 http://ruowei.ap.ngrok.io/     http://app.m.ruwe.cn/api/  测试环境http://mas.tst.ruwe.cn  瑞清：'http://192.168.199.190:7012/
