<template lang="html">
  <div class="animated fadeIn">
    <div class="alert alert-info">
			<div class="text-uppercase font-weight-bold font-xs">账户资金用于营销活动中用户获奖赠送流量扣除，活动进行时，用户获奖将按照 流量价格 扣除对应余额。流量有两种形式，一种是流量币（可随意切割大小），存放在用户流量银行内，可以累加；一种为流量包，两种大小100M、500M，不可拆分，用户需一次性使用（用户端以流量券形式存在）。</div>
		</div>
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-inverse card-info">
          <div class="card-block pb-0">
            <h4 class="mb-0">{{business_info.money}}元</h4>
            <p>可用余额</p>
          </div>
        </div>
      </div><!--/.col-->
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-inverse card-danger">
          <div class="card-block pb-0">
            ...
            <h4 class="mb-0">{{business_info.freeze_money}}元</h4>
            <p>锁定余额
    ...
    <div class="alert alert-warning">
      <strong>流量价格：</strong> 1.流量：1M={{flow_price_info.flow}}元&nbsp;&nbsp;&nbsp;&nbsp;2.流量券：100M={{flow_price_info.coupon_size_100}}元， 500M={{flow_price_info.coupon_size_500}}元
    </div>
    <div class="row">
      ...
      <div class="col-sm-6 col-md-6">
        <div class="card">
          <div class="card-block">
            ...
            <div class="h4 mb-0">{{business_info.total_purchase_money}}元</div>
      ...
      <div class="col-sm-6 col-md-6">
        <div class="card">
          <div class="card-block">
            ...
            <div class="h4 mb-0">{{business_info.total_use_money}}元</div>
