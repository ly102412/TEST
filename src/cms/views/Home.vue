    ...
    <el-row class="container">
            ...
            <el-col :span="4" class="userinfo">
                <el-dropdown trigger="click">
                    <span class="el-dropdown-link userinfo-inner"><img
                            :src="sysUserAvatar?sysUserAvatar:defaultAvatar"/> {{sysUserName ? sysUserName : defaultName}}</span>
        ...
        <el-col :span="24" class="main">
            <aside :class="collapsed?'menu-collapsed animated slideInLeft':'menu-expanded animated slideInLeft'">
                <!--导航菜单-->
                <el-menu :default-active="$route.path" class="el-menu-vertical ul-import" @open="handleopen" @close="handleclose"
                         @select="handleselect"
                ...
                <ul class="el-menu el-menu-vertical collapsed" v-show="collapsed" ref="menuCollapsed">
                    <li v-for="(item,index) in $router.options.routes" v-if="!item.hidden" class="el-submenu item">
                        ...
                        <template v-else>
                    <li class="el-submenu">
                        <div class="el-menu-item collapsed-item" style="padding-left: 20px;padding: 0 20px;"
